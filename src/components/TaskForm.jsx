        ...
        <div className={`mb-4 sm:mb-6 p-4 sm:p-6 rounded-xl sm:rounded-2xl border shadow-2xl transition-colors duration-300 ${darkMode
            ...
            <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="flex gap-2 sm:gap-3 pt-2">
                    ...
                    <button type="submit" className="flex-1 py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl text-sm sm:text-base bg-[#4f46e5] font-semibold text-white hover:bg-[#4338ca] shadow-md shadow-indigo-500/10 transition-all" onClick={addTask}>Create Task</button>
                </div>
            </form>
        </div>
    )
