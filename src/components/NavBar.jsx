        ...
        <nav className={`sticky top-0 z-50 backdrop-blur-xl border-b transition-colors duration-300 ${darkMode
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-14 sm:h-16 gap-3 sm:gap-4">
                    <div className="">
                        <img src={logo} className="h-12 w-12 sm:h-14 sm:w-14 rounded-full" />
                    </div>
                    {/* Search Bar */}
                    <div className="flex-1 max-w-2xl">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-9 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-2.5 text-base rounded-lg sm:rounded-xl transition-all focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-transparent ${darkMode
